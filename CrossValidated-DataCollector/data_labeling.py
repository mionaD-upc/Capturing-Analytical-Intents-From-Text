        ...
        for file in files:
            if file.endswith('.txt'):
                ...
                if user_input != 'yes':
                    ...
                    existing_entry = next((item for item in incorrect_files if item["label"] == folder_name), None)
...
if __name__ == "__main__":
    print("\nThe primary objective of this tool is to validate the correct assignment of files to their respective labels.\nA prerequisite for its operation is the existence of a folder containing data.\nWithin this folder, each subsequent subdirectory is designated by a unique label.\n")
